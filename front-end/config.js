(function () {
    ...
    function configuration($routeProvider) {
        $routeProvider
            ...
            .when('/staff/check-in_passengers',{
                templateUrl: 'views/staff/templates/staff-check-in.view.client.html',
                controller: 'StaffCheckInController',
                controllerAs: 'vm',
                resolve: {
                    currentUser: checkLoggedIn
                }
...
let token = "bsr2gkdwmmqkps5rjsmnhw7z";